        ...
        <div className="container">
          <div className="map">
            <ul class="map-markers">
              ...
              <li class="map-marker map-marker-huston">
                <a href="#">Huston</a>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="usa" viewBox="0 0 612 378.2">
          <g>
